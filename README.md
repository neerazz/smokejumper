...
> **Development is in progress.** The canonical progress ledger lives only in
> [`SPEC.md`](SPEC.md#12-executable-implementation-plan), alongside the commands and verification
> evidence. This landing page deliberately does not duplicate that moving status.
